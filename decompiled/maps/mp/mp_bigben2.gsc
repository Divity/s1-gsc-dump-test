...
fix_b_bomb_site_killcam()
{
    ...
    var_1[0].killcament.origin = ( 4236, 2260, 468 );
}

resetuplinkballcg()
{
    var_0 = spawn( "trigger_radius", ( 1878, 2636, 224 ), 0, 70, 50 );
    var_0.targetname = "out_of_bounds_at_rest";
    var_1 = spawn( "trigger_radius", ( 1856, 3926, 224 ), 0, 70, 50 );
...
ticketinglampost()
{
    ...
    {
        maps\mp\_utility::spawnpatchclip( "patchclip_player_128_128_128", ( 3108, 5321, var_0 ), ( 0, 0, 0 ) );
        maps\mp\_utility::spawnpatchclip( "patchclip_player_128_128_128", ( 3108, 5320, var_0 ), ( 0, 0, 0 ) );
        var_0 += 128;
    }
}
...
issue_13590()
{
    var_0 = spawn( "trigger_radius", ( 5872, 2688, 556 ), 0, 73, 50 );
    var_0.targetname = "out_of_bounds";
    var_1 = spawn( "trigger_radius", ( 5876, 3873, 556 ), 0, 73, 50 );
...
issue_16533()
{
    ...
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_64_64_64", ( 3857, 4413, 692 ), ( 0, 0, 0 ) );
    var_1 = maps\mp\_utility::spawnpatchclip( "patchclip_player_64_64_64", ( 3857, 4349, 692 ), ( 0, 0, 0 ) );
    var_2 = maps\mp\_utility::spawnpatchclip( "patchclip_player_64_64_64", ( 3857, 4285, 692 ), ( 0, 0, 0 ) );
...
issue_19907()
{
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 6040, 2720, 284 ), ( 0, 0, 0 ) );
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 6040, 2720, 156 ), ( 0, 0, 0 ) );
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 6040, 2592, 284 ), ( 0, 0, 0 ) );
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 6040, 2592, 156 ), ( 0, 0, 0 ) );
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 5968.14, 2513.89, 284 ), ( 0, 290, 0 ) );
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 5968.14, 2513.89, 156 ), ( 0, 290, 0 ) );
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 5847.86, 2470.11, 284 ), ( 0, 290, 0 ) );
    var_0 = maps\mp\_utility::spawnpatchclip( "patchclip_player_16_128_128", ( 5847.86, 2470.11, 156 ), ( 0, 290, 0 ) );
}
...
issue_23543_b()
{
    ...
    {
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 3888, 4332, var_0 ), ( 0, 0, 0 ) );
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 3872, 4332, var_0 ), ( 0, 0, 0 ) );
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 3856, 4332, var_0 ), ( 0, 0, 0 ) );
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 3840, 4332, var_0 ), ( 0, 0, 0 ) );
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 3824, 4332, var_0 ), ( 0, 0, 0 ) );
        var_0 += 256;
    }
    ...
    for ( var_1 = 0; var_1 < 4; var_1++ )
    {
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 4469, 4163, var_0 ), ( 0, 0, 0 ) );
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 4453, 4163, var_0 ), ( 0, 0, 0 ) );
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_256_256", ( 4437, 4163, var_0 ), ( 0, 0, 0 ) );
        var_0 += 256;
    }
...
issue_25514()
{
    ...
    {
        maps\mp\_utility::spawnpatchclip( "patchclip_player_16_64_64", ( 4689, 4253.5, var_0 ), ( 0, 270, 0 ) );
        var_0 += 64;
    }
}
